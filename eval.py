...
parser.add_argument(
    ...
    type=str,
    default="/home/tianyuqing/Dataset/imagenet")
parser.add_argument(
    "-g",
    '--gpu',
    ...
    type=str,
    default='all')
# change the participant GPUs by '0,1,2,3,4,5,6,7,8'
parser.add_argument(
    "-b",
    "--batch-size",
...
if args.dataset == 'imagenet':
    ...
    data_loader = torch.utils.data.DataLoader(
        datasets.CIFAR10('/home/tianyuqing/Dataset/cifar10', train=False, transform=test_transforms, download=True),
        batch_size=args.batch_size,
        shuffle=True,
        num_workers=args.workers,
        pin_memory=True,
