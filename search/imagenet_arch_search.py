...
parser.add_argument('--path', type=str, default='imagenet')
parser.add_argument('--gpu', help='gpu available', default='6,7')
...
# ref_val = 96 + 10 + 60 = 164 ms 
# parser.add_argument('--width_stages', type=str, default='24,40,80,96,192,320')
# parser.add_argument('--n_cell_stages', type=str, default='4,4,4,4,4,1')
# parser.add_argument('--stride_stages', type=str, default='2,2,2,1,2,1')
# parser.add_argument('--width_stages', type=str, default='20,40,80,160,320')
# parser.add_argument('--n_cell_stages', type=str, default='4,4,4,4,4')
# parser.add_argument('--stride_stages', type=str, default='2,2,2,2,1')
parser.add_argument('--width_stages', type=str, default='32,48,88,104,216,320')
parser.add_argument('--n_cell_stages', type=str, default='4,4,4,4,4,1')
parser.add_argument('--stride_stages', type=str, default='2,2,2,1,2,1')
...
parser.add_argument('--target_hardware', type=str, default="mobile", choices=['mobile', 'cpu', 'gpu8', 'flops', None])
