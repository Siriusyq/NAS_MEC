...
""" net config """
parser.add_argument('--width_stages', type=str, default='16,32,64,128,192')
parser.add_argument('--n_cell_stages', type=str, default='4,2,2,2,1')
parser.add_argument('--stride_stages', type=str, default='2,1,2,1,1')
