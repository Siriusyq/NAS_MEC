...
from training.utils.bags_of_tricks import cross_encropy_with_label_smoothing
...
# parser.add_argument('--train-dir', default=os.path.expanduser('$HOME/Dataset/imagenet/train'),
#                     help='path to training data')
# parser.add_argument('--val-dir', default=os.path.expanduser('$HOME/Dataset/imagenet/val'),
#                     help='path to validation data')
parser.add_argument('--save_path', default=os.path.expanduser('~/Dataset/cifar10'),
                    help='path to validation data')
...
train_dataset = datasets.CIFAR10(args.save_path,
                         train=True,
...
val_dataset = datasets.CIFAR10(args.save_path,
                         train=False,
