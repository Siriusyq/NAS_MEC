...
# FIXME
parser.add_argument('--train-dir', default=os.path.expanduser('/home/tianyuqing/Dataset/imagenet/train'),
                    help='path to training data')
parser.add_argument('--val-dir', default=os.path.expanduser('/home/tianyuqing/Dataset/imagenet/val'),
